...
export const BUILDING_CONFIG: Record<BuildingType, BuildingConfig> = {
  ...
  park: { cost: 140, env: 8, stars: 2, sat: 7, income: 0, upkeep: 3, name: '公园' },
  school: { cost: 220, env: 0, stars: 0, sat: 10, income: 0, upkeep: 5, name: '学校' },
  subway: { cost: 380, env: 6, stars: 2, sat: 13, income: 3, upkeep: 9, name: '地铁站' },
  wind: { cost: 240, env: 8, stars: 4, sat: 0, income: 2, upkeep: 4, name: '风力发电' },
  solar: { cost: 280, env: 10, stars: 7, sat: 0, income: 3, upkeep: 4, name: '太阳能电站' },
  hospital: { cost: 320, env: 0, stars: -1, sat: 14, income: 0, upkeep: 9, name: '医院' },
  police: { cost: 260, env: 0, stars: -1, sat: 10, income: 0, upkeep: 6, name: '警察局' },
  fire_station: { cost: 260, env: 0, stars: -1, sat: 10, income: 0, upkeep: 6, name: '消防站' },
  library: { cost: 210, env: 1, stars: 1, sat: 10, income: 0, upkeep: 4, name: '图书馆' },
